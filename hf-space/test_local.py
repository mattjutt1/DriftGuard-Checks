...
def test_single_optimization():
    ...
    result = optimize_prompt_mock(test_prompt, task_desc, "balanced", 0.7)
...
def test_batch_processing():
    ...
    prompts = ["Explain quantum computing", "How to make pizza", "Debug this Python code"]
...
def test_api_format():
    ...
    api_request = {
        "data": ["Summarize this article", "News article summarization", "thorough", 0.8]
    }
