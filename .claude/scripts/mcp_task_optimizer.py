...
class MCPTaskOptimizer:
    def __init__(self):
        self.available_servers = {
            "context7": {
                ...
                "keywords": ["library", "documentation", "framework", "api", "docs", "reference", "research"],
            ...
            "sequential-thinking": {
                ...
                "keywords": ["analyze", "complex", "multi-step", "reasoning", "logic", "problem-solving", "debug"],
        ...
        self.task_patterns = {
            "frontend": ["frontend", "ui", "component", "react", "next.js", "tailwind", "responsive"],
    ...
    def recommend_mcp_servers(self, task_text: str, domains: List[str]) -> List[Dict]:
        ...
        for server_name, server_info in self.available_servers.items():
            ...
            if any(word in task_text for word in ["complex", "analyze", "multi-step", "debug"]) and server_name == "sequential-thinking":
                score += 20
