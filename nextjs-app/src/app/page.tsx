...
export default function Home() {
  ...
  const handleOptimize = async (useAdvanced = false) => {
    ...
    try {
      ...
      if (useAdvanced) {
        await advancedOptimization({ sessionId, iterations: 2 });
      } else {
      ...
      alert("Optimization failed. Please check if Ollama is running and the Qwen3:4b model is available.");
    } finally {
      ...
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            AI-Powered Prompt Optimization with Qwen3-8B
          </p>
          <button
            onClick={checkHealth}
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <button
                  ...
                  disabled={!prompt.trim() || isOptimizing}
                  className="w-full py-3 px-4 bg-purple-600 text-white font-medium rounded-md hover:bg-purple-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
                >
                  {isOptimizing ? "Advanced Processing..." : "Advanced PromptWizard Optimization"}
                </button>
                
                <p className="text-xs text-gray-500 text-center">
                  Advanced mode uses iterative PromptWizard techniques for higher quality results
                </p>
              </div>
            </div>
          </div>
