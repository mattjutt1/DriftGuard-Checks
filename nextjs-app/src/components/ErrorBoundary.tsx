 ...
 * Provides graceful error handling and user-friendly error displays
 */
 ...
 * For displaying specific errors within the application
 */
 ...
 * For connection and loading errors
 */
