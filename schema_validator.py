...
class DomainRouter:
    ...
    def __init__(self):
        self.domain_keywords = {
            "analytics": [
                "data", "analyze", "metric", "report", "insight", "trend",
                "statistics", "dashboard", "kpi", "visualization"
            ],
            "coding": [
                "code", "function", "bug", "optimize", "api", "debug",
                "implement", "algorithm", "class", "method", "performance"
            ],
            "content": [
                "write", "blog", "article", "content", "document", "explain",
                "describe", "summary", "email", "copy", "text"
            ],
            "cross_domain": [
                "plan", "strategy", "process", "system", "design", "build",
                "create", "develop", "improve", "help"
            ]
        }
