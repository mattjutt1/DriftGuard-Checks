...
from promptevolver_cli.config import CONVEX_BASE_URL, API_TIMEOUT
        ...
        responses.add(
            ...
            json={
                ...
                "data": {
                    "success": True,
                    "result": {
                        "best_prompt": "Minimal optimization",
                        "quality_score": 75.0
                    }
                }
            },
...
class TestPerformanceAndReliability:
    ...
    def test_large_request_handling(self):
        ...
        large_config = {
            "domain": "general",
            "large_data": ["item" + str(i) for i in range(100)]
        }
